...
const Footer = () => {
  return (
    <div id='contact' className='bg-[#ccb57e] p-5 lg:p-20 lg:pb-10 lg:pt-10 mt-10'>
      <h1 className='text-[#222222d4] text-lg md:text-3xl text-center'>Contact Us</h1>
      ...
      <div className='flex justify-around flex-wrap lg:flex-nowrap gap-x-14 gap-y-5 md:gap-y-10 '>
        ...
        <div className='flex justify-center gap-5 lg:gap-10  xl:justify-between w-full'>
